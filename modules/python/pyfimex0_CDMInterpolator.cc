...
void changeProjection1(CDMInterpolator_p i, InterpolationMethod method, const std::string& proj_input, const py::iterable& out_x_axis,
                       const py::iterable& out_y_axis, const std::string& out_x_axis_unit, const std::string& out_y_axis_unit, CDMDataType out_x_axis_type,
...
void changeProjection2(CDMInterpolator_p i, InterpolationMethod method, const py::iterable& lonVals, const py::iterable& latVals)
{
...
void changeProjection1_1(CDMInterpolator_p i, InterpolationMethod method, const std::string& proj_input, const py::iterable& out_x_axis,
                         const py::iterable& out_y_axis, const std::string& out_x_axis_unit, const std::string& out_y_axis_unit)
{
...
void pyfimex0_CDMInterpolator(py::module m)
{
    ...
    py::class_<CDMInterpolator, CDMInterpolator_p, CDMReader>(m, "_CDMInterpolator")
    ...
    m.def("createInterpolator", createInterpolator);
}
