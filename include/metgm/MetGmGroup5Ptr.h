...
namespace MetNoFimex {
    ...
    public:
        static boost::shared_ptr<MetGmGroup5Ptr> createMetGmGroup5Ptr(CDMReader* pCdmReader,
    ...
    boost::shared_ptr<MetGmGroup5Ptr> MetGmGroup5Ptr::createMetGmGroup5Ptr(CDMReader* pCdmReader,
                                                                           const CDMVariable* pVariable,
