/*
 * Fimex, LambertAzimuthalEqualAreaProjection.cc
 *
...
{
    return proj4ProjectionMatchesName(proj4Str, "laea");
}
...
std::ostream& LambertAzimuthalEqualAreaProjection::getProj4ProjectionPart(std::ostream& oproj) const
{
    oproj << "+proj=laea";
