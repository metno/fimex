...
const po::option op_output_type = po::option("output.type", "filetype of output file, e.g. nc, nc4, nc3, nc4classic, grib1, grib2");
...
const po::option op_interpolate_method = po::option("interpolate.method", "interpolation method, one of nearestneighbor (default), bilinear, bicubic, coord_nearestneighbor, coord_kdtree, forward_max, forward_min, forward_mean, forward_median, forward_sum or forward_undef_*");
