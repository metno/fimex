...
int run(int argc, char* args[])
{
    ...
    config.add_options()
        ...
        ("interpolate.method", po::value<string>(), "interpolation method, one of nearestneighbor, bilinear, bicubic, coord_nearestneighbor, coord_kdtree, forward_max, forward_mean, forward_median, forward_sum or forward_undef_*")
        ...
        ("merge.method", po::value<string>(), "interpolation method for grid conversions, one of nearestneighbor, bilinear, bicubic,"
                " coord_nearestneighbor, coord_kdtree, forward_max, forward_mean, forward_median, forward_sum or forward_undef_* (*=max,mean,median,sum")
