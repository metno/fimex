...
void FeltCDMReader::init() throw(MetNoFelt::Felt_File_Error, CDMException) {
...
std::vector<std::string> FeltCDMReader::initGetKnownFeltIdsFromXML(const XMLDoc& doc)
{
...
CDMDimension FeltCDMReader::initAddTimeDimensionFromXML(const XMLDoc& doc)
{
...
std::map<short, CDMDimension> FeltCDMReader::initAddLevelDimensionsFromXML(const XMLDoc& doc)
{
...
void FeltCDMReader::initAddProjectionFromXML(const XMLDoc& doc, std::string& projName, std::string& coordinates)
{
...
void FeltCDMReader::initAddVariablesFromXML(const XMLDoc& doc, const std::string& projName, const std::string& coordinates, const CDMDimension& timeDim, const std::map<short, CDMDimension>& levelDims)
{
...
boost::shared_ptr<Data> FeltCDMReader::getDataSlice(const std::string& varName, size_t unLimDimPos) throw(CDMException) {
