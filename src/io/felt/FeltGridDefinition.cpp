...
std::array<float, 6> gridParametersPolarStereo_(int ixp, int iyp, int idist, int iphi, const std::vector<short int>& extraData)
{
    ...
    if (gridPar[2] != 0)
        gridPar[2] = 79. * 150. / gridPar[2];
    else
        throw std::runtime_error("polar-stereographic: cells between equator and pole cannot be 0");
...
std::array<float, 6> gridParameters(int gridType, int a, int b, int c, int d, const std::vector<short int>& extraData)
{
    ...
    case 1:
    case 4:
        return gridParametersPolarStereo_(a, b, c, d, extraData);
        break;
    case 2:
    case 3:
        return gridParametersGeographic_(a, b, c, d, extraData);
        break;
    case 5:
        return gridParametersMercator_(a, b, c, d, extraData);
        break;
    case 6:
        return gridParametersLambertConic_(a, b, c, d, extraData);
        break;
    }
...
FeltGridDefinition::FeltGridDefinition(int gridType, int xNum, int yNum, int a, int b, int c, int d, const std::vector<short int>& extraData)
    : gridType_(gridType)
    , xNum_(xNum)
    , yNum_(yNum)
{
...
void FeltGridDefinition::polarStereographicProj_(int gridType, int a, int b, int c, int d, const std::vector<short int>& extraData)
{
    ...
    if (FeltFile::isLogging()) {
        ...
        buffer << "Grid Specification: " << gridPars_[0] << " | " << gridPars_[1] << " | " << gridPars_[2] << " | " << gridPars_[3] << " | " << gridPars_[4]
               << " | " << gridPars_[5] << std::endl;
...
void FeltGridDefinition::geographicProj_(int gridType, int a, int b, int c, int d, const std::vector<short int>& extraData)
{
    gridPars_ = gridParameters(gridType, a, b, c, d, extraData);
...
void FeltGridDefinition::mercatorProj_(int gridType, int a, int b, int c, int d, const std::vector<short int>& extraData)
{
    gridPars_ = gridParameters(gridType, a, b, c, d, extraData);
...
void FeltGridDefinition::lambertConicProj_(int gridType, int a, int b, int c, int d, const std::vector<short int>& extraData)
{
    gridPars_ = gridParameters(gridType, a, b, c, d, extraData);
...
void FeltGridDefinition::polarStereographicProj(int gridType, float poleX, float poleY, float gridD, float rot, const std::vector<short int>& extraData)
{
...
void FeltGridDefinition::geographicProj(int gridType, float startLongitude, float startLatitude, float iInc, float jInc,
...
int FeltGridDefinition::getXNumber() const
{
    return xNum_;
};

int FeltGridDefinition::getYNumber() const
{
    return yNum_;
};

float FeltGridDefinition::getXIncrement() const
{
    return incrementX_;
};

float FeltGridDefinition::getYIncrement() const
{
    return incrementY_;
};

float FeltGridDefinition::startLatitude() const
{
    return startY_;
};

float FeltGridDefinition::startLongitude() const
{
    return startX_;
};

float FeltGridDefinition::startX() const
{
    return startX_;
};

float FeltGridDefinition::startY() const
{
    return startY_;
};
...
{
    return out << "FeltGridDefinition( " << grid.getXIncrement() << ", " << grid.getYIncrement() << ", " << grid.startLongitude() << ", "
               << grid.startLatitude() << " )" << std::endl;
}
